        ...
        <section class="mb-4">
            <h1 class="h3 text-black">Gestión de Usuarios</h1>
            <p class="text-muted">Administración de cuentas de usuario del sistema</p>
        </section>
            ...
            <div class="card card-body">
                ...
                <form class="row g-3">
                    <div class="mb-3 d-flex gap-2 flex-wrap filtros">
                        <input type="text" id="filtroCuenta" placeholder="Filtrar por cuenta" class="form-control">
                        <input type="text" id="filtroCorreo" placeholder="Filtrar por correo" class="form-control">
